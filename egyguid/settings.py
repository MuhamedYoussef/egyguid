...
try:
    with open(f'{BASE_DIR}/egyguid/config.json') as f:
        config = json.load(f)
except:
    pass
...
ALLOWED_HOSTS = ['localhost', 'egyguid.herokuapp.com']
...
WSGI_APPLICATION = 'egyguid.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'egyguid/static')
]
